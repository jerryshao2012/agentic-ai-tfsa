...
class ModelName(str, Enum):
    # Make sure Ollama qwen2.5vl:7b model is installed locally
    ollama_qwen2_5vl_7b = "qwen2.5vl:7b"
    # deepseek-chat has tools support
...
DEFAULT_MODEL = ModelName.watsonx_llama_3_2_90b
